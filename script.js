    ...
    $.ajax({
        ...
        if (response.bestMatches["0"]["1. symbol"] === querySymbol) {
            ...
            $.ajax({
                ...
                $.ajax({
                    url: "https://rest.coinapi.io/v1/exchangerate/BTC/USD?apikey=3E618E22-0BFE-4AE3-96DD-CE807B909C95",
                    method: "GET"
                }).then(function (response) {
            ...
            var AVurl = "https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=" + stuff + "&apikey=8R49FW9VLKSNE9JK";
            $.ajax({
                url: AVurl,
                method: "GET"
            }).then(function (response) {
